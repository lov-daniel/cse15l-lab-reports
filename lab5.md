...
"Thank you for providing screenshots of the symptoms, there seems to be a few things going on at once, so we can try to break them down one by one. Are you on a Windows machine by any chance? Remember, there are two different ways to run JUnit depending on your operating system, refer to the course website on [Week 6](https://ucsd-cse15l-w24.github.io/week6/index.html) to double check if you're running the right one.
